...
| common                                    | locker                | A binary sensor who block opening for open, close and adaptive when state is On                                                        | config.common.locker                                             | None    | Binary Sensor/Input Boolean Entity  | Optional |
...
| position                                  | closed                | Define the min position allowed (%) when cover is closed                                                                               | config.common.position.closed                                    | 0       | Integer                             | Optional |
...
| opening                                   | locker                | A binary sensor who block opening when state is On                                                                                     | config.common.opening.locker                                     | None    | Binary Sensor/Input Boolean Entity  | Optional |
| opening.position                          | default               | Position (between 0 and 100) to open covers. If not defined, default is config.common.position.opened                                  | config.common.opening.position.default                           | None    | Integer                             | Optional |
| opening.position.seasons                  | <season_name>         | Position (between 0 and 100) to open covers at a specific season. If not defined, default is config.common.opening.position.default    | config.common.opening.position.seasons.<season_name>             | None    | Integer                             | Optional |
...
| closing                                   | locker                | A binary sensor who block closing when state is On                                                                                     | config.common.closing.locker                                     | None    | Binary Sensor/Input Boolean Entity  | Optional |
| closing                                   | bypass_global_locker  | Define if closing is allow to bypass global locker (usage: close everytime it's requested without condition to global locker)          | config.common.closing.bypass_global_locker                       | False   | Boolean                             | Optional |
...
| closing.position                          | default               | Position (between 0 and 100) to close covers. If not defined, default is config.common.position.closed                                 | config.common.closing.position.default                           | None    | Integer                             | Optional |
| closing.position.seasons                  | <season_name>         | Position (between 0 and 100) to close covers at a specific season. If not defined, default is config.common.closing.position.default   | config.common.closing.position.seasons.<season_name>             | None    | Integer                             | Optional |
